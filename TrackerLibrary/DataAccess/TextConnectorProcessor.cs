...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
        ...
        public static List<string> LoadFile(this string file) // file == full file path
        {
            if (!File.Exists(file)) // 16:12:00
            {
        ...
        {
            //id,teamName, list of ids of people (seperated by |)
            //3, Tim's team, 1|3|5
        ...
        public static void SaveMatchupToFile (this MatchupModel matchup, string matchupFile, string matchupEntryFile)
        {
            ...
            foreach (MatchupModel m in matchups)
            {
                ...
                lines.Add($"{m.Id},{m.Entries.ConvertMatchupEntryListToString()},{winnerId},{m.MatchupRound}");
            }
        ...
        public static void SaveToTournamentFile(this List<TournamentModel> models, string fileName)
        {
            ...
            foreach (TournamentModel tm in models)
            {
                ...
                // id, TournamentName, EntryFee, (id|id|id) EnteredTeams, (id|id|id) Prizes, Rounds - (id^id^id|id^id^id|id^id^id)
                // 3,Basketball tournament,50.00,2|3|5,5|6|8,?????
            }
